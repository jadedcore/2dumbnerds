<div class="row">
	<div class="col-md-offset-2 col-md-8">
		<h1>Edit Category <small><?= h($theCategory->name);?></small></h1>
		<?= $this->Form->create($theCategory);?>
			<legend><?= __('Edit Category Information');?></legend>
			<div class="row">
				<div class="col-md-12">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="form-group">
						...
						<?=
							$this->Form->button(__('<span class="glyphicon glyphicon-saved"></span>&nbsp;Save Changes'),
